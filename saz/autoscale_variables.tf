...
* We have kept default value here as 1. If user needs to change that can be done by changing default value below.
* This variable will be used only in autoscale that means if user has given enable_autoscaling value to be true.
**/
...
* We have kept default value here as 70. If user needs to change that can be done by changing default value below.
* This variable will be used only in autoscale that means if user has given enable_autoscaling value to be true.
**/
