...
resource "ibm_is_instance_group" "web_instance_group" {
  ...
  instance_template  = ibm_is_instance_template.web_template[0].id
...
resource "ibm_is_instance_group_manager" "web_instance_group_manager" {
  ...
  instance_group       = ibm_is_instance_group.web_instance_group[0].id
...
resource "ibm_is_instance_group_manager_policy" "web_cpu_policy" {
  ...
  policy_type            = "target"
  instance_group         = ibm_is_instance_group.web_instance_group[0].id
  instance_group_manager = ibm_is_instance_group_manager.web_instance_group_manager[0].manager_id
  metric_type            = "cpu"
...
**/
# locals {
#   web_private_ips = flatten(data.ibm_is_instances.web_ig_members[0].instances[*].primary_network_interface[0].primary_ipv4_address)
# }
